document.addEventListener('DOMContentLoaded', () => {
    ...
    // 5. Carousel logic (generalized for all .v-carousel)
    ...
    function initLightbox() {
        ...
        // Dynamically add a zoom hint icon to all trace image wrappers
        const wrappers = document.querySelectorAll('.trace-image-wrapper');
        wrappers.forEach(wrapper => {
            if (wrapper.querySelector('.trace-img')) {
